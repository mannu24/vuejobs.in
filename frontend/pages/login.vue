  ...
  <div class="min-h-[70vh] flex items-center justify-center px-4">
    <div class="bg-white rounded-xl border border-gray-200 p-8 w-full max-w-md">
      ...
      <form @submit.prevent="handleLogin">
        ...
        <button
          type="submit"
          class="w-full bg-vue text-white py-2.5 rounded-lg font-medium hover:bg-vue/90 transition"
          :disabled="loading"
        >
      ...
      <button
        class="w-full flex items-center justify-center gap-2 border border-gray-300 rounded-lg py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 transition"
