<template>
  <NuxtLink
    :to="`/jobs/${job.slug}`"
    class="bg-white rounded-xl p-6 border border-gray-200 hover:border-vue/50 hover:shadow-md transition group"
    :class="{ 'ring-2 ring-vue/30 border-vue/40': job.featured_until }"
  >
    <div class="flex items-start gap-4">
      <div class="w-12 h-12 rounded-lg bg-gray-100 flex items-center justify-center text-gray-400 text-xs font-bold shrink-0 overflow-hidden">
        <img
